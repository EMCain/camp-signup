...
function onRequestChange() { //more descriptive name
    ...
    if ((request.readyState == 4) && (request.status == 200)) {
        ...
        var output = "<div class='container' id='campers_of_family'>"; // TODO better variable name
        ...
        for (var item in data) { // TODO better name for item
            ...
            // TODO: create methods for constructing each row
            // TODO: create for-loops for the standard text in each row
...
//creates the form section with questions about children
            ...
            //TODO create method with for loops
        ...
        for (var item in data) {
            ...
            drawFormSections(id); // TODO change name to diff verb than "draw"
        }
    }
